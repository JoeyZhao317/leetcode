...
public class Sudoku {
    ...
    public boolean validValue(char[][] board, int row, int column, char value) {
        ...
        if (validRow(board, row, value) && validColumn(board, column, value)
    ...
    private boolean validRow(char[][] board, int row, char value) {
        boolean result = true;
        for (int i = 0; i < 9; i++) {
    ...
    private boolean validColumn(char[][] board, int column, char value) {
        boolean result = true;
        for (int i = 0; i < 9; i++) {
